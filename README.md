...
The launches with a dummy <b><i>initalizing screen</b></i> which configures the app for the first time use. 
...
<img src = "appScreens/login_page_lm.jpg" height = "400" width = "225">
...
<br><br>
<img src = "appScreens/explore_page_lm.jpg" height = "400" width = "225">
<img src = "appScreens/explore_page_two.jpg" height = "400" width = "225">
<img src = "appScreens/explore_page_three.jpg" height = "400" width = "225">
## Recipe Page:
It uses Flutter's powerful, `GridView` widget, to show different recipes from the dummy data model in an asthteic appeal.  
<br><br>
<img src = "appScreens/recipes_page_lm.jpg" height = "400" width = "225">
## To Buy Page:
...
<br><br>
<img src = "appScreens/to_buy_page_lm.jpg" height = "400" width = "225">
<img src = "appScreens/added_items_lm.jpg" height = "400" width = "225">
<img src = "appScreens/add_grocery_page_lm.jpg" height = "400" width = "225">
<br>
The three packages used for other aspects of to add grocery page are:<br>
`flutter_colorpicker: ^0.6.0`<br>
`intl: ^0.17.0`<br><br>
<img src = "appScreens/color_picker_page.jpg" height = "400" width = "225">
<img src = "appScreens/date_picker_page.jpg" height = "400" width = "225">
<img src = "appScreens/time_picker_page.jpg" height = "400" width = "225">
## Profile Page:
...
initialize again. 
<br>
<img src = "appScreens/profile_page_lm.jpg" height = "400" width = "225">
## Dark Theme:
On pressing the dark mode, button the UI refreshes to show dark mode, using inbuilt flutter `ThemeData` class.
<br>
<img src = "appScreens/explore_page_dm.jpg" height = "400" width = "225">
<img src = "appScreens/recipes_page_dm.jpg" height = "400" width = "225">
<img src = "appScreens/added_items_dm.jpg" height = "400" width = "225"><br>
